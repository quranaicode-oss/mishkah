(function (global) {
  const SocialBNWSchema = {
    name: 'socialbnw_business_network',
    version: 1,
    comment:
      'Normalized schema for the SocialBNW business marketing network that blends social storytelling with commerce primitives.',
    entities: {
      users: {
        name: 'user_account',
        label: 'User Account',
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = SocialBNWSchema;
  }

  global.SocialBNWSchema = SocialBNWSchema;
