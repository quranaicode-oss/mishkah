    ...
    const TEXTS = {
      ar:{
        ...
        toast:{
          ...
          table_required:'يرجى اختيار طاولة قبل حفظ طلب الصالة',
          delivery_customer_required:'يرجى إدخال بيانات العميل وعنوانه قبل حفظ طلب التوصيل',
      ...
      en:{
        ...
        toast:{
          ...
          table_required:'Please select a table before saving dine-in orders',
          delivery_customer_required:'Please attach customer details and address before saving delivery orders',
