...
export type NormalizedNode = NormalizedElement | NormalizedText | NormalizedExpr | NormalizedIf | NormalizedFor;
...
export interface AtomDescriptor {
    family: 'Containers' | 'Text' | 'Lists' | 'Forms' | 'Inputs' | 'Media' | 'Tables' | 'SVG';
    name: string;
}
